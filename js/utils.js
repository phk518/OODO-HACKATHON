...
function renderNavbar(user) {
  ...
  nav.innerHTML = `
    ...
    <nav class="navbar-nav" aria-label="Main navigation">
      ...
      <a href="discovery.html"   class="nav-link" id="nav-discovery">
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5"/></svg>
        Discovery
      </a>
      <a href="community.html"   class="nav-link" id="nav-community">
    ...
    <div class="navbar-actions">
      ...
      <div class="dropdown">
        ...
        <div class="dropdown-menu" id="user-menu" role="menu">
          ...
          <a href="notes.html"       class="dropdown-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg> Notes & Journal</a>
          <a href="packing.html"     class="dropdown-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="2" y="7" width="20" height="15" rx="2"/><path d="M16 7V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2"/></svg> Packing List</a>
          <a href="preferences.html" class="dropdown-item"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/></svg> Travel Preferences</a>
